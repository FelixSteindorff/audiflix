...
MENUS: list[tuple[str, list]] = [
    ...
    (N_("&Playback"), [
        ...
        None,
        ("prev_track", N_("Previous audio file"), "prev_track", None),
        ("next_track", N_("Next audio file"), "next_track", None),
        ("jump_to_time", N_("&Jump to position..."), "jump_to_time", None),
        None,
        ("speed_up", N_("Faster"), "speed_up", None),
        ("speed_down", N_("Slower"), "speed_down", None),
        ("speed_reset", N_("Reset speed"), "speed_reset", None),
        ("set_speed", N_("Set speed for this title..."), None, None),
        None,
        ...
        ("announce_sleep", N_("Announce sleep timer"), "announce_sleep", None),
    ...
    (N_("&Item"), [
        ...
        ("ctx_download", N_("Do&wnload for offline listening"), None, None),
        ("ctx_remove_download", N_("&Remove download"), None, None),
    ]),
    (N_("&Help"), [
        ("shortcuts", N_("&Keyboard shortcuts"), None, "F1"),
        ("log_folder", N_("Open &log folder"), None, None),
        ("check_updates", N_("Check for &updates..."), None, None),
        ("diagnostics", N_("Copy &diagnostics"), None, None),
